            ...
            <div className="lg:col-span-2">
                ...
                <div className="space-y-3">
                    {pasajeros.map((p, index) => (
                        <div key={p.passenger.id} className="bg-white p-4 rounded-lg shadow-md border border-gray-200 hover:border-red-500 hover:shadow-lg transition-all duration-200">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 sm:px-4">
                                <div>
